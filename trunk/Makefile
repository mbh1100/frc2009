...
SRC_DIR := .
BUILD_ROOT_DIR := 
PRJ_ROOT_DIR := C:/WindRiver/workspace/SkyNet
...
DEP_FILES := $(OBJ_DIR)/PIDJaguar.d $(OBJ_DIR)/HardwareInterface.d $(OBJ_DIR)/SmartRelay.d
-include $(DEP_FILES)

ifeq ($(BUILD_SPEC),PPC32diab)
SUBDIRS :=
OBJECTS := $(OBJ_DIR)/PIDJaguar.o $(OBJ_DIR)/HardwareInterface.o $(OBJ_DIR)/SmartRelay.o
...
ifeq ($(BUILD_SPEC),PPC603gnu)
SUBDIRS := "C:/WindRiver/workspace/SkyNet/.settings"
OBJECTS := $(OBJ_DIR)/PIDJaguar.o $(OBJ_DIR)/HardwareInterface.o $(OBJ_DIR)/SmartRelay.o
